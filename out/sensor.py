...
async def async_setup_entry(hass, entry: ConfigEntry, async_add_devices):
    ...
    meter_data = hass.data[DOMAIN][entry.entry_id].connector.meter_data
    # meters = []
    ...
    # )
    # meters.append(ForsyningSensor(config, hass, region, this_sensor))

    # async_add_devices(meters)

    _LOGGER.debug(meter_data)
    return True


# class ForsyningSensor(SensorEntity):
#     """Representation of Forsyning data."""
